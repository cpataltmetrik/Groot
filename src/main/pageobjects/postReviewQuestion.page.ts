...
export default class PostReviewQuestion extends Page {
    ...
    public get selectMobile() {
        return <any>(
            $(
                '//span[contains(text(),"Redmi Note 11 (Horizon Blue, 6GB RAM, ")]',
            )
        );
    }
    ...
    public get postQuestion() {
        return <any>(
            $(
                "(//span[@class='a-size-base a-text-bold']//parent::div/..//a//button)[1]",
            )
        );
    }
    ...
    public get popUpValidate() {
        return <any>(
            $("//p[contains(text(),'Your question might be answered')]")
        );
    }
    ...
    public get postButton() {
        return <any>(
            $(
                "(//form[@method='post']//parent::div//p/../..//button[@type='button'])[2]",
            )
        );
    }
